...
import 'sub_screens/reserve_donation_screen.dart';

class BloodNeedersScreen extends StatefulWidget {
  const BloodNeedersScreen({Key? key}) : super(key: key);

  @override
  State<BloodNeedersScreen> createState() => _BloodNeedersScreenState();
}

class _BloodNeedersScreenState extends State<BloodNeedersScreen> {
  // Declarations
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Text(
                                                          '${AppLocalData.elementsNeeder[index]['age']} années . ${'${AppLocalData.elementsNeeder[index]['gender']}'.toCapitalized()}',
                                                          maxLines: 1,
                                                          softWrap: false,
                                                          overflow:
                                                              TextOverflow.fade,
