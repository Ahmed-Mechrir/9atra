...
class AdviseDetailsScreen extends StatefulWidget {
  const AdviseDetailsScreen({Key? key, required this.index}) : super(key: key);

  final int index;

  @override
  State<AdviseDetailsScreen> createState() => _AdviseDetailsScreenState();
}

class _AdviseDetailsScreenState extends State<AdviseDetailsScreen> {
  @override
  void initState() {
    super.initState();
  }
