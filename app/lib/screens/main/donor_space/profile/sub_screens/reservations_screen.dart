import 'package:app_9atra/config/constants.dart';
import 'package:app_9atra/utils/extentions.dart';
import 'package:app_9atra/widgets/global/toast_widget.dart';
...
class _ReservationsScreenState extends State<ReservationsScreen> {
  ...
  void _onLoading() async {
    ...
    AppLocalData.elementsNeeder.add(
      (AppLocalData.elementsNeeder.length + 1),
    );
    if (mounted) {
      setState(() {});
    }
                          ...
                          child: AnimationLimiter(
                            child: SmartRefresher(
                              ...
                              child: ListView.builder(
                                shrinkWrap: true,
                                itemCount:
                                    AppLocalData.elementsMyReservations.length,
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Container(
                                                        ...
                                                        child: const QrGeneratorWidget(
                                                          data: 'qatra|2022HGHSPj23416JHGSDjhkd6309jhsdj652',
                                                          size: 200.0,
                                                        ),
                                                      ),
                                                    ],
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: FittedBox(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            Text(
                                                              '${AppLocalData.elementsMyReservations[index]['day']}',
                                                              style:
                                                                  const TextStyle(
                                                                fontSize: 40,
                                                                fontWeight:
                                                            ...
                                                            Row(
                                                              ...
                                                              children: <
                                                                  Widget>[
                                                                Text(
                                                                  '${AppLocalData.elementsMyReservations[index]['month']}'
                                                                  '/'
                                                                  '${AppLocalData.elementsMyReservations[index]['year']}',
                                                                  style:
                                                                      const TextStyle(
                                                                    fontSize:
                                                                        12,
                                                          ...
                                                          Expanded(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: <
                                                                  Widget>[
                                                                Text(
                                                                  '${AppLocalData.elementsMyReservations[index]['center']}'
                                                                      .toCapitalized(),
                                                                  maxLines: 2,
                                                                  softWrap:
                                                                      true,
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: <
                                                                    ...
                                                                    Text(
                                                                      'Don de ${'${AppLocalData.elementsMyReservations[index]['litre_sang']}'.toCapitalized()}L',
                                                                      maxLines:
                                                                          1,
                                                                      softWrap:
                                                                          false,
                                                                    ...
                                                                    text:
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        TextSpan(
                                                                          text:
                                                                              ' '
                                                                              '${AppLocalData.elementsMyReservations[index]['status']}',
                                                                          style:
                                                                              TextStyle(
                                                                            fontSize:
                                                                                _width * 0.025,
