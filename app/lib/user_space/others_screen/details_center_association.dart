...
class DetailsCenterAssociationScreen extends StatefulWidget {
  const DetailsCenterAssociationScreen({Key? key}) : super(key: key);

  @override
  _DetailsCenterAssociationScreenState createState() =>
      _DetailsCenterAssociationScreenState();
}

class _DetailsCenterAssociationScreenState
    extends State<DetailsCenterAssociationScreen> {
  // Declarations
                      ...
                      SizedBox(
                        ...
                        child: ReadMoreText(
                          ...
                          moreStyle: TextStyle(
                            fontSize: _width * .033,
                            fontWeight: FontWeight.w600,
                            color: AppColors.red_color.withOpacity(0.6),
                          ),
                          lessStyle: TextStyle(
                            fontSize: _width * .033,
                            fontWeight: FontWeight.w600,
                          ...
                          children: <Widget>[
                            ...
                            ClipRRect(
                              ...
                              child: SizedBox(
                                width: _width,
                                height: _height * 0.48,
                                child: const CenterAssociationMap(
